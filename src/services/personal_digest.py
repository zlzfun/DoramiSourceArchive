...
# 会开新同日 revision 的原因。interest_changed/subscription_changed 自 v3.50.1 起不再由
...
def edition_freshness(
    ...
    v3.50.1(issue #33 §5):兴趣/订阅变更不再自动重编当日早报,读者看到的今日版面
...
def generate_personal_digest(
    ...
    *,
    ...
    historical editions never move with today's preferences.  Since v3.50.1 reader
