...
│   ├── routers/             # 按域拆分的 Router 群(articles/vector/reader/admin/archive_sync/…); v3.18 新增 feedback.py / announcements.py / remote_sync.py
